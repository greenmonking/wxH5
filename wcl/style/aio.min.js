...
function(e, t) {
    ...
    function r(e, n, i, r) {
        if (ct.acceptData(e)) {
            ...
            u = l ? ct.cache: e,
            c = l ? e[s] : e[s] && s;
            if (c && u[c] && (r || u[c].data) || i !== t || "string" != typeof n) return c || (c = l ? e[s] = tt.pop() || ct.guid++:s),
            u[c] || (u[c] = l ? {}: {
                toJSON: ct.noop
            }),
            ("object" == typeof n || "function" == typeof n) && (r ? u[c] = ct.extend(u[c], n) : u[c].data = ct.extend(u[c].data, n)),
            a = u[c],
            r || (a.data || (a.data = {}), a = a.data),
            i !== t && (a[ct.camelCase(n)] = i),
        ...
        if (ct.acceptData(e)) {
            ...
            if (a[l]) {
                if (t && (i = n ? a[l] : a[l].data)) {
                    ct.isArray(t) ? t = t.concat(ct.map(t, ct.camelCase)) : t in i ? t = [t] : (t = ct.camelCase(t), t = t in i ? [t] : t.split(" ")),
                    r = t.length;
                    for (; r--;) delete i[t[r]];
    ...
    function x(e, n) {
        ...
        if (!a) for (a = [], i = e.childNodes || e; null != (r = i[o]); o++) ! n || ct.nodeName(r, n) ? a.push(r) : ct.merge(a, x(r, n));
    ...
    function S(e, t) {
        ...
        i.style && (o[a] = ct._data(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && C(i) && (o[a] = ct._data(i, "olddisplay", N(i.nodeName)))) : o[a] || (r = C(i), (n && "none" !== n || !r) && ct._data(i, "olddisplay", r ? n: ct.css(i, "display"))));
        for (a = 0; s > a; a++) i = e[a],
    ...
    function E(e, t, n, i, r) {
        for (var o = n === (i ? "border": "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)"margin" === n && (a += ct.css(e, n + Sn[o], !0, r)),
        i ? ("content" === n && (a -= ct.css(e, "padding" + Sn[o], !0, r)), "margin" !== n && (a -= ct.css(e, "border" + Sn[o] + "Width", !0, r))) : (a += ct.css(e, "padding" + Sn[o], !0, r), "padding" !== n && (a += ct.css(e, "border" + Sn[o] + "Width", !0, r)));
        return a
    }
    function L(e, t, n) {
        var i = !0,
        ...
        if (0 >= r || null == r) {
            ...
            i = a && (ct.support.boxSizingReliable || r === e.style[t]),
            r = parseFloat(r) || 0
        }
    ...
    function N(e) {
        var t = J,
        n = bn[e];
        return n || (n = M(e, t), "none" !== n && n || (cn = (cn || ct("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (cn[0].contentWindow || cn[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = M(e, t), cn.detach()), bn[e] = n),
        n
    }
    function M(e, t) {
    ...
    function H(e, n) {
        ...
        return i && ct.extend(!0, e, i),
        e
    }
    function W(e, n, i) {
        for (var r, o, a, s, l = e.contents,
             u = e.dataTypes;
             "*" === u[0];) u.shift(),
    ...
    function z(e, t, n) {
        ...
        l = function() {
            if (r) return ! 1;
            for (var t = Zn || I(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(o);
        ...
        c = u.props;
        for (B(c, u.opts.specialEasing); a > o; o++) if (i = ri[o].call(u, e, c, u.opts)) return i;
        return ct.map(c, O, u),
    ...
    function R(e, t, n) {
        ...
        1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], "inline" === ct.css(e, "display") && "none" === ct.css(e, "float") && (ct.support.inlineBlockNeedsLayout && "inline" !== N(e.nodeName) ? d.zoom = 1 : d.display = "inline-block")),
        n.overflow && (d.overflow = "hidden", ct.support.shrinkWrapBlocks || u.always(function() {
        ...
        if (!ct.isEmptyObject(c)) {
            ...
            for (i in c) a = O(p ? f[i] : 0, i, u),
            i in f || (f[i] = a.start, p && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    function $(e, t, n, i, r) {
    ...
    Ct = function(e) { (J.addEventListener || "load" === e.type || "complete" === J.readyState) && (St(), ct.ready())
    },
    St = function() {
    ...
    ct.fn = ct.prototype = {
        ...
        init: function(e, n, i) {
            ...
            if ("string" == typeof e) {
                ...
                if (r[1]) {
                    if (n = n instanceof ct ? n[0] : n, ct.merge(this, ct.parseHTML(r[1], n && n.nodeType ? n.ownerDocument || n: J, !0)), gt.test(r[1]) && ct.isPlainObject(n)) for (r in n) ct.isFunction(this[r]) ? this[r](n[r]) : this.attr(r, n[r]);
                    return this
                }
    ...
    ct.extend = ct.fn.extend = function() {
        ...
        l = 2), "object" == typeof s || ct.isFunction(s) || (s = {}), u === l && (s = this, --l); u > l; l++) if (null != (o = arguments[l])) for (r in o) e = s[r],
        i = o[r],
        s !== i && (c && i && (ct.isPlainObject(i) || (n = ct.isArray(i))) ? (n ? (n = !1, a = e && ct.isArray(e) ? e: []) : a = e && ct.isPlainObject(e) ? e: {},
        s[r] = ct.extend(c, a, i)) : i !== t && (s[r] = i));
        return s
    },
    ct.extend({
        ...
        ready: function(e) {
            if (e === !0 ? !--ct.readyWait: !ct.isReady) {
                ...
                ct.isReady = !0,
                e !== !0 && --ct.readyWait > 0 || (V.resolveWith(J, [ct]), ct.fn.trigger && ct(J).trigger("ready").off("ready"))
            }
        },
        ...
        parseXML: function(n) {
            ...
            return i && i.documentElement && !i.getElementsByTagName("parsererror").length || ct.error("Invalid XML: " + n),
            i
        },
        noop: function() {},
        ...
        makeArray: function(e, t) {
            var i = t || [];
            return null != e && (n(Object(e)) ? ct.merge(i, "string" == typeof e ? [e] : e) : rt.call(i, e)),
            i
        },
        ...
        proxy: function(e, n) {
            ...
            ct.isFunction(e) ? (i = ot.call(arguments, 2), r = function() {
    ...
    ct.ready.promise = function(t) {
        if (!V) if (V = ct.Deferred(), "complete" === J.readyState) setTimeout(ct.ready);
    ...
    function(e, t) {
        function n(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t: z) !== P && D(t), t = t || P, n = n || [], !e || "string" != typeof e) return n;
            if (1 !== (s = t.nodeType) && 9 !== s) return [];
            if (W && !i) {
                if (r = wt.exec(e)) if (a = r[1]) {
                    if (9 === s) {
                    ...
                    n;
                    if ((a = r[3]) && C.getElementsByClassName && t.getElementsByClassName) return et.apply(n, t.getElementsByClassName(a)),
                    n
                }
                if (C.qsa && (!j || !j.test(e))) {
        ...
        function p(e, t) {
            ...
            for (s = e, l = [], u = k.preFilter; s;) { (!i || (r = dt.exec(s))) && (r && (s = s.slice(r[0].length) || s), l.push(o = [])),
            i = !1,
            (r = pt.exec(s)) && (i = r.shift(), o.push({
                value: i,
                type: r[0].replace(ut, " ")
            }), s = s.slice(i.length));
        ...
        function h(e, t, n) {
            ...
            function(t, n, o) {
                ...
                } else for (; t = t[i];) if (1 === t.nodeType || r) if (u = t[O] || (t[O] = {}), (l = u[i]) && l[0] === c) {
                    if ((s = l[1]) === !0 || s === S) return s === !0
                } else if (l = u[i] = [c], l[1] = e(t, n, a) || S, l[1] === !0) return ! 0
            }
        }
        function g(e) {
            return e.length > 1 ?
        ...
        function v(e, t, n, i, o, a) {
            ...
            r(function(r, a, s, l) {
                ...
                y = n ? o || (r ? e: h || i) ? [] : a: v;
                if (n && n(v, y, s, l), i) for (u = m(y, f), i(u, [], s, l), c = u.length; c--;)(d = u[c]) && (y[f[c]] = !(v[f[c]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function y(e) {
            for (var t, n, i, r = e.length,
                 o = k.relative[e[0].type], a = o || k.relative[" "], s = o ? 1 : 0, l = h(function(e) {
                return e === t
            },
            a, !0), u = h(function(e) {
            ...
            }]; r > s; s++) if (n = k.relative[e[s].type]) c = [h(g(c), n)];
            else {
        ...
        function w(e, t) {
            ...
            s = function(r, s, l, u, c) {
                ...
                if (g += v, o && v !== g) {
                    ...
                    if (r) {
                        if (g > 0) for (; v--;) y[v] || h[v] || (h[v] = Q.call(u));
                        h = m(h)
                    }
                    et.apply(u, h),
                    w && !r && h.length > 0 && g + t.length > 1 && n.uniqueSort(u)
                }
                return w && (B = T, M = x),
                y
            };
        ...
        function b(e, t, n, i) {
            ...
            if (!i && 1 === u.length) {
                if (o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && C.getById && 9 === t.nodeType && W && k.relative[o[1].type]) {
                    if (t = (k.find.ID(a.matches[0].replace(Ct, St), t) || [])[0], !t) return n;
                    e = e.slice(o.shift().value.length)
                }
                for (r = vt.needsContext.test(e) ? 0 : o.length; r--&&(a = o[r], !k.relative[s = a.type]);) if ((l = k.find[s]) && (i = l(a.matches[0].replace(Ct, St), ft.test(o[0].type) && t.parentNode || t))) {
                    if (o.splice(r, 1), e = i.length && f(o), !e) return et.apply(n, i),
                    n;
                    break
                }
            }
            return N(e, u)(i, t, !W, n, ft.test(e)),
            n
        }
        ...
        try {
            et.apply(K = tt.call(z.childNodes), z.childNodes),
        ...
        D = n.setDocument = function(e) {
            ...
            n = t.defaultView;
            return t !== P && 9 === t.nodeType && t.documentElement ? (P = t, H = t.documentElement, W = !L(t), n && n.attachEvent && n !== n.top && n.attachEvent("onbeforeunload",
            function() {
                D()
            ...
            _ = [], j = [], (C.qsa = yt.test(t.querySelectorAll)) && (o(function(e) {
                ...
                e.querySelectorAll("[selected]").length || j.push("\\[" + rt + "*(?:value|" + it + ")"),
                e.querySelectorAll(":checked").length || j.push(":checked")
            }), o(function(e) {
                var n = t.createElement("input");
                n.setAttribute("type", "hidden"),
                e.appendChild(n).setAttribute("t", ""),
                e.querySelectorAll("[t^='']").length && j.push("[*^$]=" + rt + "*(?:''|\"\")"),
                ...
                F.call(e, "[s!='']:x"),
                _.push("!=", lt)
            }), j = j.length && new RegExp(j.join("|")), _ = _.length && new RegExp(_.join("|")), I = yt.test(H.contains) || H.compareDocumentPosition ?
            function(e, t) {
        ...
        n.matchesSelector = function(e, t) {
            if ((e.ownerDocument || e) !== P && D(e), t = t.replace(ht, "='$1']"), !(!C.matchesSelector || !W || _ && _.test(t) || j && j.test(t))) try {
                var i = F.call(e, t);
        ...
        n.attr = function(e, n) { (e.ownerDocument || e) !== P && D(e);
        ...
        k = n.selectors = {
            ...
            filter: {
                ...
                CLASS: function(e) {
                    var t = $[e + " "];
                    return t || (t = new RegExp("(^|" + rt + ")" + e + "(" + rt + "|$)")) && $(e,
                    function(e) {
                    ...
                    function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild: m.lastChild], a && y) {
                                for (c = m[O] || (m[O] = {}), u = c[e] || [], f = u[0] === B && u[1], p = u[0] === B && u[2], d = f && m.childNodes[f]; d = ++f && d && d[g] || (p = f = 0) || h.pop();) if (1 === d.nodeType && ++p && d === t) {
                                    c[e] = [B, f, p];
                                    break
                                }
                            } else if (y && (u = (t[O] || (t[O] = {}))[e]) && u[0] === B) p = u[1];
                            else for (; (d = ++f && d && d[g] || (p = f = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v: 1 !== d.nodeType) || !++p || (y && ((d[O] || (d[O] = {}))[e] = [B, p]), d !== t)););
                            return p -= r,
                            p === i || p % i === 0 && p / i >= 0
                        }
                    }
                ...
                PSEUDO: function(e, t) {
                    ...
                    return o[O] ? o(t) : o.length > 1 ? (i = [e, e, "", t], k.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, n) {
                        for (var i, r = o(e, t), a = r.length; a--;) i = nt.call(e, r[a]),
                        e[i] = !(n[i] = r[a])
                    }) : function(e) {
                        return o(e, 0, i)
                    }) : o
            ...
            pseudos: {
                ...
                lang: r(function(e) {
                    ...
                    function(t) {
                        var n;
                        do
                            if (n = W ? t.lang: t.getAttribute("xml:lang") || t.getAttribute("lang")) return n = n.toLowerCase(),
                            n === e || 0 === n.indexOf(e + "-");
        ...
        C.sortStable = O.split("").sort(X).join("") === O,
    ...
    ct.Callbacks = function(e) {
        e = "string" == typeof e ? kt[e] || i(e) : ct.extend({},
        e);
        var n, r, o, a, s, l, u = [],
        c = !e.once && [],
        d = function(t) {
        ...
        p = {
            ...
            remove: function() {
                ...
                function(e, t) {
                    for (var i; (i = ct.inArray(t, u, i)) > -1;) u.splice(i, 1),
                    n && (a >= i && a--, s >= i && s--)
                }),
                this
            },
            ...
            fireWith: function(e, t) {
                return ! u || o && !c || (t = t || [], t = [e, t.slice ? t.slice() : t], n ? c.push(t) : d(t)),
                this
            },
            fire: function() {
    ...
    ct.extend({
        ...
        when: function(e) {
            ...
            if (a > 1) for (t = new Array(a), n = new Array(a), i = new Array(a); a > r; r++) o[r] && ct.isFunction(o[r].promise) ? o[r].promise().done(u(r, i, o)).fail(l.reject).progress(u(r, n, t)) : --s;
        ...
        data: function(e, n) {
            ...
            if (e === t) {
                if (this.length && (o = ct.data(l), 1 === l.nodeType && !ct._data(l, "parsedAttrs"))) {
                    for (i = l.attributes; s < i.length; s++) r = i[s].name,
                    0 === r.indexOf("data-") && (r = ct.camelCase(r.slice(5)), a(l, r, o[r]));
    ...
    ct.fn.extend({
        queue: function(e, n) {
            ...
            arguments.length < i ? ct.queue(this[0], e) : n === t ? this: this.each(function() {
        ...
        promise: function(e, n) {
            ...
            for ("string" != typeof e && (n = e, e = t), e = e || "fx"; s--;) i = ct._data(a[s], e + "queueHooks"),
    ...
    ct.fn.extend({
        ...
        addClass: function(e) {
            ...
            if (l) for (t = (e || "").match(pt) || []; s > a; a++) if (n = this[a], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(At, " ") : " ")) {
        ...
        toggleClass: function(e, t) {
            ...
            function(n) {
                ...
                if ("string" === n) for (var t, i = 0,
                                         r = ct(this), o = e.match(pt) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
        ...
        val: function(e) {
            var n, i, r, o = this[0]; {
                if (arguments.length) return r = ct.isFunction(e),
                this.each(function(n) {
                    var o;
                    1 === this.nodeType && (o = r ? e.call(this, n, ct(this).val()) : e, null == o ? o = "": "number" == typeof o ? o += "": ct.isArray(o) && (o = ct.map(o,
                    function(e) {
                        return null == e ? "": e + ""
                    })), i = ct.valHooks[this.type] || ct.valHooks[this.nodeName.toLowerCase()], i && "set" in i && i.set(this, o, "value") !== t || (this.value = o))
                });
                if (o) return i = ct.valHooks[o.type] || ct.valHooks[o.nodeName.toLowerCase()],
    ...
    ct.extend({
            ...
            select: {
                get: function(e) {
                    for (var t, n, i = e.options,
                         ...
                         a = o ? null: [], s = o ? r + 1 : i.length, l = 0 > r ? s: o ? r: 0; s > l; l++) if (n = i[l], !(!n.selected && l !== r || (ct.support.optDisabled ? n.disabled: null !== n.getAttribute("disabled")) || n.parentNode.disabled && ct.nodeName(n.parentNode, "optgroup"))) {
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options,
                         o = ct.makeArray(t), a = r.length; a--;) i = r[a],
                    (i.selected = ct.inArray(ct(i).val(), o) >= 0) && (n = !0);
        ...
        removeAttr: function(e, t) {
            var n, i, r = 0,
            o = t && t.match(pt);
            if (o && 1 === e.nodeType) for (; n = o[r++];) i = ct.propFix[n] || n,
            ct.expr.match.bool.test(n) ? _t && jt || !Wt.test(n) ? e[i] = !1 : e[ct.camelCase("default-" + n)] = e[i] = !1 : ct.attr(e, n, ""),
        ...
        prop: function(e, n, i) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s) return a = 1 !== s || !ct.isXMLDoc(e),
    ...
    Mt = {
        set: function(e, t, n) {
            return t === !1 ? ct.removeAttr(e, n) : _t && jt || !Wt.test(n) ? e.setAttribute(!jt && ct.propFix[n] || n, n) : e[ct.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
    ...
    function(e, n) {
        ...
        ct.expr.attrHandle[n] = _t && jt || !Wt.test(n) ?
        function(e, n, r) {
    ...
    ct.event = {
        ...
        add: function(e, n, i, r, o) {
            ...
            if (v) {
                ...
                d.elem = e), n = (n || "").match(pt) || [""], l = n.length; l--;) a = Bt.exec(n[l]) || [],
                h = m = a[1],
                g = (a[2] || "").split(".").sort(),
        ...
        remove: function(e, t, n, i, r) {
            ...
            if (m && (c = m.events)) {
                for (t = (t || "").match(pt) || [""], u = t.length; u--;) if (s = Bt.exec(t[u]) || [], f = g = s[1], h = (s[2] || "").split(".").sort(), f) {
                    for (d = ct.event.special[f] || {},
                         f = (i ? d.delegateType: d.bindType) || f, p = c[f] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = p.length; o--;) a = p[o],
                    !r && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || i && i !== a.selector && ("**" !== i || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, d.remove && d.remove.call(e, a));
        ...
        handlers: function(e, n) {
            ...
            if (l && u.nodeType && (!e.button || "click" !== e.type)) for (; u != this; u = u.parentNode || this) if (1 === u.nodeType && (u.disabled !== !0 || "click" !== e.type)) {
                ...
                i = r.selector + " ",
                o[i] === t && (o[i] = r.needsContext ? ct(i, this).index(u) >= 0 : ct.find(i, this, null, [u]).length),
                o[i] && o.push(r);
                o.length && s.push({
                    elem: u,
                    handlers: o
        ...
        fix: function(e) {
            ...
            o = e,
            a = this.fixHooks[r];
            for (a || (this.fixHooks[r] = a = Ot.test(r) ? this.mouseHooks: It.test(r) ? this.keyHooks: {}), i = a.props ? this.props.concat(a.props) : this.props, e = new ct.Event(o), t = i.length; t--;) n = i[t],
            e[n] = o[n];
        ...
        mouseHooks: {
            ...
            filter: function(e, n) {
                ...
                s = n.fromElement;
                return null == e.pageX && null != n.clientX && (r = e.target.ownerDocument || J, o = r.documentElement, i = r.body, e.pageX = n.clientX + (o && o.scrollLeft || i && i.scrollLeft || 0) - (o && o.clientLeft || i && i.clientLeft || 0), e.pageY = n.clientY + (o && o.scrollTop || i && i.scrollTop || 0) - (o && o.clientTop || i && i.clientTop || 0)),
        ...
        simulate: function(e, t, n, i) {
            ...
            i ? ct.event.trigger(r, null, t) : ct.event.dispatch.call(t, r),
    ...
    function(e, t) {
        ct.event.special[e] = {
            ...
            handle: function(e) {
                ...
                r = e.relatedTarget,
                o = e.handleObj;
                return (!r || r !== i && !ct.contains(i, r)) && (e.type = o.origType, n = o.handler.apply(this, arguments), e.type = t),
                n
            }
        }
    }),
    ct.support.submitBubbles || (ct.event.special.submit = {
        setup: function() {
            return ct.nodeName(this, "form") ? !1 : void ct.event.add(this, "click._submit keypress._submit",
            function(e) {
                var n = e.target,
                i = ct.nodeName(n, "input") || ct.nodeName(n, "button") ? n.form: t;
                i && !ct._data(i, "submitBubbles") && (ct.event.add(i, "submit._submit",
                function(e) {
                    e._submit_bubble = !0
    ...
    ct.support.changeBubbles || (ct.event.special.change = {
        setup: function() {
            ...
            })), !1) : void ct.event.add(this, "beforeactivate._change",
            function(e) {
                var t = e.target;
    ...
    ct.fn.extend({
        ...
        off: function(e, n, i) {
            ...
            ct(e.delegateTarget).off(r.namespace ? r.origType + "." + r.namespace: r.origType, r.selector, r.handler),
            this;
            if ("object" == typeof e) {
    ...
    ct.fn.extend({
        find: function(e) {
            ...
            return n = this.pushStack(r > 1 ? ct.unique(n) : n),
        ...
        closest: function(e, t) {
            for (var n, i = 0,
                 r = this.length,
                 o = [], a = qt.test(e) || "string" != typeof e ? ct(e, t || this.context) : 0; r > i; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && ct.find.matchesSelector(n, e))) {
                n = o.push(n);
                break
            }
    ...
    function(e, t) {
        ct.fn[e] = function(n, i) {
            ...
            this.length > 1 && (Gt[e] || (r = ct.unique(r)), $t.test(e) && (r = r.reverse())),
            this.pushStack(r)
        }
    }),
    ct.extend({
        filter: function(e, t, n) {
            var i = t[0];
            return n && (e = ":not(" + e + ")"),
            1 === t.length && 1 === i.nodeType ? ct.find.matchesSelector(i, e) ? [i] : [] : ct.find.matches(e, ct.grep(t,
            function(e) {
                return 1 === e.nodeType
            }))
        },
        dir: function(e, n, i) {
            for (var r = [], o = e[n]; o && 9 !== o.nodeType && (i === t || 1 !== o.nodeType || !ct(o).is(i));) 1 === o.nodeType && r.push(o),
            o = o[n];
            return r
        },
    ...
    ct.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, i = e ? ct.filter(e, this) : this, r = 0; null != (n = i[r]); r++) t || 1 !== n.nodeType || ct.cleanData(x(n)),
            n.parentNode && (t && ct.contains(n.ownerDocument, n) && v(x(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
        ...
        domManip: function(e, t, n) {
            ...
            if (c && (l = ct.buildFragment(e, this[0].ownerDocument, !1, !n && this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
                for (a = ct.map(x(l, "script"), g), o = a.length; c > u; u++) r = l,
                u !== p && (r = ct.clone(r, !0, !0), o && ct.merge(a, x(r, "script"))),
                t.call(this[u], r, u);
                if (o) for (s = a[a.length - 1].ownerDocument, ct.map(a, m), u = 0; o > u; u++) r = a[u],
                rn.test(r.type || "") && !ct._data(r, "globalEval") && ct.contains(s, r) && (r.src ? ct._evalUrl(r.src) : ct.globalEval((r.text || r.textContent || r.innerHTML || "").replace(an, "")));
                l = i = null
            }
            return this
        }
    ...
    function(e, t) {
        ct.fn[e] = function(e) {
            for (var n, i = 0,
                 r = [], o = ct(e), a = o.length - 1; a >= i; i++) n = i === a ? this: this.clone(!0),
            ct(o[i])[t](n),
            rt.apply(r, n.get());
    ...
    ct.extend({
        clone: function(e, t, n) {
            ...
            if (ct.support.html5Clone || ct.isXMLDoc(e) || !Yt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (un.innerHTML = e.outerHTML, un.removeChild(o = un.firstChild)), !(ct.support.noCloneEvent && ct.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ct.isXMLDoc(e))) for (i = x(o), s = x(e), a = 0; null != (r = s[a]); ++a) i[a] && w(r, i[a]);
        ...
        buildFragment: function(e, t, n, i) {
            for (var r, o, a, s, l, u, c, d = e.length,
                 p = f(t), h = [], g = 0; d > g; g++) if (o = e[g], o || 0 === o) if ("object" === ct.type(o)) ct.merge(h, o.nodeType ? [o] : o);
            else if (Zt.test(o)) {
                ...
                if (!ct.support.leadingWhitespace && Ut.test(o) && h.push(t.createTextNode(Ut.exec(o)[0])), !ct.support.tbody) for (o = "table" !== l || Qt.test(o) ? "<table>" !== c[1] || Qt.test(o) ? 0 : s: s.firstChild, r = o && o.childNodes.length; r--;) ct.nodeName(u = o.childNodes[r], "tbody") && !u.childNodes.length && o.removeChild(u);
                for (ct.merge(h, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = p.lastChild
            } else h.push(t.createTextNode(o));
            for (s && p.removeChild(s), ct.support.appendChecked || ct.grep(x(h, "input"), b), g = 0; o = h[g++];) if ((!i || -1 === ct.inArray(o, i)) && (a = ct.contains(o.ownerDocument, o), s = x(p.appendChild(o), "script"), a && v(s), n)) for (r = 0; o = s[r++];) rn.test(o.type || "") && n.push(o);
            return s = null,
            p
        },
        cleanData: function(e, t) {
            for (var n, i, r, o, a = 0,
                 ...
                 c = ct.event.special; null != (n = e[a]); a++) if ((t || ct.acceptData(n)) && (r = n[s], o = r && l[r])) {
    ...
    ct.extend({
        ...
        style: function(e, n, i, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (a = typeof i, "string" === a && (o = xn.exec(i)) && (i = (o[1] + 1) * o[2] + parseFloat(ct.css(e, n)), a = "number"), !(null == i || "number" === a && isNaN(i) || ("number" !== a || ct.cssNumber[l] || (i += "px"), ct.support.clearCloneStyle || "" !== i || 0 !== n.indexOf("background") || (u[n] = "inherit"), s && "set" in s && (i = s.set(e, i, r)) === t))) try {
                    u[n] = i
                } catch(c) {}
            }
        },
        css: function(e, n, i, r) {
            var o, a, s, l = ct.camelCase(n);
            return n = ct.cssProps[l] || (ct.cssProps[l] = T(e.style, l)),
            s = ct.cssHooks[n] || ct.cssHooks[l],
            s && "get" in s && (a = s.get(e, !0, i)),
            a === t && (a = pn(e, n, r)),
            "normal" === a && n in Cn && (a = Cn[n]),
            "" === i || i ? (o = parseFloat(a), i === !0 || ct.isNumeric(o) ? o || 0 : a) : a
        }
    }),
    ...
    pn = function(e, n, i) {
        ...
        u = e.style;
        return s && ("" !== l || ct.contains(e.ownerDocument, e) || (l = ct.style(e, n)), wn.test(l) && vn.test(n) && (r = u.width, o = u.minWidth, a = u.maxWidth, u.minWidth = u.maxWidth = u.width = l, l = s.width, u.width = r, u.minWidth = o, u.maxWidth = a)),
        l
    ...
    pn = function(e, n, i) {
        ...
        wn.test(l) && !gn.test(n) && (r = u.left, o = e.runtimeStyle, a = o && o.left, a && (o.left = e.currentStyle.left), u.left = "fontSize" === n ? "1em": l, l = u.pixelLeft + "px", u.left = r, a && (o.left = a)),
        "" === l ? "auto": l
    }),
    ...
    function(e, t) {
        ct.cssHooks[t] = {
            get: function(e, n, i) {
                return n ? 0 === e.offsetWidth && mn.test(ct.css(e, "display")) ? ct.swap(e, Tn,
                function() {
                    return L(e, t, i)
                }) : L(e, t, i) : void 0
            },
    ...
    ct.support.opacity || (ct.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1,
            (t >= 1 || "" === t) && "" === ct.trim(o.replace(fn, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || i && !i.filter) || (n.filter = fn.test(o) ? o.replace(fn, r) : o + " " + r)
        }
    }),
    ct(function() {
    ...
    function(e, t) {
        ct.cssHooks[e + t] = {
            expand: function(n) {
                for (var i = 0,
                     r = {},
                     o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) r[e + Sn[i] + t] = o[i] || o[i - 2] || o[0];
                return r
            }
        },
    ...
    try {
        ...
        Pn = J.createElement("a"),
        Pn.href = "",
        Pn = Pn.href
    }
    Dn = Bn.exec(Pn.toLowerCase()) || [],
    ct.fn.load = function(e, n, i) {
        if ("string" != typeof e && Rn) return Rn.apply(this, arguments);
        var r, o, a, s = this,
        l = e.indexOf(" ");
        return l >= 0 && (r = e.slice(l, e.length), e = e.slice(0, l)),
        ct.isFunction(n) ? (i = n, n = t) : n && "object" == typeof n && (a = "POST"),
        s.length > 0 && ct.ajax({
            url: e,
            type: a,
            dataType: "html",
            ...
            o = arguments,
            s.html(r ? ct("<div>").append(ct.parseHTML(e)).find(r) : e)
        }).complete(i &&
        function(e, t) {
    ...
    ct.extend({
        ...
        ajax: function(e, n) {
            ...
            n = n || {};
            var r, o, a, s, l, u, c, d, p = ct.ajaxSetup({},
            n),
            f = p.context || p,
            ...
            a = p.url,
            p.hasContent || (p.data && (a = p.url += (Wn.test(a) ? "&": "?") + p.data, delete p.data), p.cache === !1 && (p.url = _n.test(a) ? a.replace(_n, "$1_=" + Hn++) : a + (Wn.test(a) ? "&": "?") + "_=" + Hn++)),
            p.ifModified && (ct.lastModified[a] && T.setRequestHeader("If-Modified-Since", ct.lastModified[a]), ct.etag[a] && T.setRequestHeader("If-None-Match", ct.etag[a])),
    ...
    function(e, n) {
        ct[n] = function(e, i, r, o) {
            return ct.isFunction(i) && (o = o || r, r = i, i = t),
            ct.ajax({
                url: e,
                type: n,
                dataType: o,
    ...
    Jn = ct.ajaxSettings.xhr(),
    ct.support.cors = !!Jn && "withCredentials" in Jn,
    Jn = ct.support.ajax = !!Jn,
    Jn && ct.ajaxTransport(function(n) {
            ...
            return {
                send: function(r, o) {
                    ...
                    i = function(e, r) {
                        var s, u, c, d;
                        try {
                            if (i && (r || 4 === l.readyState)) if (i = t, a && (l.onreadystatechange = ct.noop, Qn && delete Un[a]), r) 4 !== l.readyState && l.abort();
                            else {
                                d = {},
                                s = l.status,
                    ...
                    n.async ? 4 === l.readyState ? setTimeout(i) : (a = ++Kn, Qn && (Un || (Un = {},
                    ct(e).unload(Qn)), Un[a] = i), l.onreadystatechange = i) : i()
                },
                abort: function() {
                    i && i(t, !0)
                }
    ...
    ct.fn.extend({
        ...
        animate: function(e, t, n, i) {
            ...
            o = ct.speed(t, n, i),
            a = function() {
                var t = z(this, ct.extend({},
                e), o); (r || ct._data(this, "finish")) && t.stop(!0)
            };
            return a.finish = a,
        ...
        stop: function(e, n, i) {
            ...
            this.each(function() {
                ...
                else for (n in a) a[n] && a[n].stop && ii.test(n) && r(a[n]);
                for (n = o.length; n--;) o[n].elem !== this || null != e && o[n].queue !== e || (o[n].anim.stop(i), t = !1, o.splice(n, 1)); (t || !i) && ct.dequeue(this, e)
            })
        },
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
    ...
    ct.speed = function(e, t, n) {
        var i = e && "object" == typeof e ? ct.extend({},
        e) : {
    ...
    ct.timers = [],
    ct.fx = $.prototype.init,
    ct.fx.tick = function() {
        var e, n = ct.timers,
        i = 0;
        for (Zn = ct.now(); i < n.length; i++) e = n[i],
    ...
    ct.fn.offset = function(e) {
        ...
        ct.contains(n, o) ? (typeof o.getBoundingClientRect !== Y && (r = o.getBoundingClientRect()), i = G(a), {
    ...
    ct.offset = {
        setOffset: function(e, t, n) {
            ...
            d = {},
            p = {};
            c ? (p = a.position(), r = p.top, o = p.left) : (r = parseFloat(l) || 0, o = parseFloat(u) || 0),
...
function(e) {
    ...
    e.removeCookie = function(t, n) {
        return void 0 === e.cookie(t) ? !1 : (e.cookie(t, "", e.extend({},
        n, {
            expires: -1
        })), !e.cookie(t))
    }
...
var Swiper = function(e, t) {
    ...
    function r() {
        var e = D - W;
        return t.freeMode && (e = D - W),
        t.slidesPerView > N.slides.length && !t.centeredSlides && (e = 0),
        0 > e && (e = 0),
        e
    }
    function o() {
        ...
        if (N.browser.ie10 || N.browser.ie11 ? (i(r, N.touchEvents.touchStart, g), i(document, N.touchEvents.touchMove, m), i(document, N.touchEvents.touchEnd, v)) : (N.support.touch && (i(r, "touchstart", g), i(r, "touchmove", m), i(r, "touchend", v)), t.simulateTouch && (i(r, "mousedown", g), i(document, "mousemove", m), i(document, "mouseup", v))), t.autoResize && i(window, "resize", N.resizeFix), a(), N._wheelEvent = !1, t.mousewheelControl) {
            ...
            N._wheelEvent || (N._wheelEvent = "DOMMouseScroll"),
            N._wheelEvent && i(N.container, N._wheelEvent, u)
        }
    ...
    function a() {
        ...
        if (t.onSlideClick) for (e = 0; e < N.slides.length; e++) i(N.slides[e], "click", c);
        if (t.onSlideTouch) for (e = 0; e < N.slides.length; e++) i(N.slides[e], N.touchEvents.touchStart, d)
    }
    function s() {
    ...
    function l(e) {
        ...
        if (! (e.shiftKey || e.altKey || e.ctrlKey || e.metaKey)) {
            if (37 === t || 39 === t || 38 === t || 40 === t) {
                for (var n = !1,
                     i = N.h.getOffset(N.container), r = N.h.windowScroll().left, o = N.h.windowScroll().top, a = N.h.windowWidth(), s = N.h.windowHeight(), l = [[i.left, i.top], [i.left + N.width, i.top], [i.left, i.top + N.height], [i.left + N.width, i.top + N.height]], u = 0; u < l.length; u++) {
                    var c = l[u];
    ...
    function u(e) {
        ...
        else if ("mousewheel" === n) if (t.mousewheelControlForceToAxis) if (I) {
        ...
        else if ("wheel" === n) if (t.mousewheelControlForceToAxis) if (I) {
        ...
        } else(new Date).getTime() - V > 60 && (0 > i ? N.swipeNext() : N.swipePrev()),
        V = (new Date).getTime();
        return t.autoplay && N.stopAutoplay(!0),
    ...
    function d(e) {
        p(e),
        N.fireCallback(t.onSlideTouch, N, e)
    }
    function p(e) {
        ...
        N.clickedSlideIndex = N.slides.indexOf(N.clickedSlide),
        N.clickedSlideLoopIndex = N.clickedSlideIndex - (N.loopedSlides || 0)
    }
    function f(e) {
    ...
    function g(e) {
        ...
        if (!K || 1 === e.targetTouches.length) {
            N.callPlugins("onTouchStartBegin"),
            !K && !N.isAndroid && i.indexOf(n.tagName.toLowerCase()) < 0 && (e.preventDefault ? e.preventDefault() : e.returnValue = !1);
            var r = K ? e.targetTouches[0].pageX: e.pageX || e.clientX,
            o = K ? e.targetTouches[0].pageY: e.pageY || e.clientY;
            N.touches.startX = N.touches.currentX = r,
            N.touches.startY = N.touches.currentY = o,
            N.touches.start = N.touches.current = I ? r: o,
            N.setWrapperTransition(0),
            N.positions.start = N.positions.current = N.getWrapperTranslate(),
            N.setWrapperTranslate(N.positions.start),
            N.times.start = (new Date).getTime(),
            H = void 0,
            t.moveStartThreshold > 0 && (Y = !1),
            t.onTouchStart && N.fireCallback(t.onTouchStart, N, e),
            N.callPlugins("onTouchStartEnd")
        }
    }
    function m(e) {
        if (N.isTouched && !t.onlyExternal && (!K || "mousemove" !== e.type)) {
            ...
            if ("undefined" == typeof H && I && (H = !!(H || Math.abs(i - N.touches.startY) > Math.abs(n - N.touches.startX))), "undefined" != typeof H || I || (H = !!(H || Math.abs(i - N.touches.startY) < Math.abs(n - N.touches.startX))), H) return void(N.isTouched = !1);
            if (I) {
            ...
            if (e.assignedToSwiper = !0, t.preventLinks && (N.allowLinks = !1), t.onSlideClick && (N.allowSlideClick = !1), t.autoplay && N.stopAutoplay(!0), !K || 1 === e.touches.length) {
                ...
                if (t.moveStartThreshold) if (Math.abs(N.touches.current - N.touches.start) > t.moveStartThreshold || Y) {
                    if (!Y) return Y = !0,
                    void(N.touches.start = N.touches.current);
                ...
                return (t.freeMode || t.watchActiveIndex) && N.updateActiveSlide(N.positions.current),
                t.grabCursor && (N.container.style.cursor = "move", N.container.style.cursor = "grabbing", N.container.style.cursor = "-moz-grabbin", N.container.style.cursor = "-webkit-grabbing"),
                U || (U = N.touches.current),
                J || (J = (new Date).getTime()),
                N.velocity = (N.touches.current - U) / ((new Date).getTime() - J) / 2,
                Math.abs(N.touches.current - U) < 2 && (N.velocity = 0),
                U = N.touches.current,
                J = (new Date).getTime(),
                N.callPlugins("onTouchMoveEnd"),
                t.onTouchMove && N.fireCallback(t.onTouchMove, N, e),
                !1
            }
        }
    }
    function v(e) {
        if (H && N.swipeReset(), !t.onlyExternal && N.isTouched) {
            N.isTouched = !1,
            t.grabCursor && (N.container.style.cursor = "move", N.container.style.cursor = "grab", N.container.style.cursor = "-moz-grab", N.container.style.cursor = "-webkit-grab"),
            N.positions.current || 0 === N.positions.current || (N.positions.current = N.positions.start),
            t.followFinger && N.setWrapperTranslate(N.positions.current),
            N.times.end = (new Date).getTime(),
            N.touches.diff = N.touches.current - N.touches.start,
            N.touches.abs = Math.abs(N.touches.diff),
            N.positions.diff = N.positions.current - N.positions.start,
            N.positions.abs = Math.abs(N.positions.diff);
            var n = N.positions.diff,
            i = N.positions.abs,
            o = N.times.end - N.times.start;
            5 > i && 300 > o && N.allowLinks === !1 && (t.freeMode || 0 === i || N.swipeReset(), t.preventLinks && (N.allowLinks = !0), t.onSlideClick && (N.allowSlideClick = !0)),
            setTimeout(function() {
                "undefined" != typeof N && null !== N && (t.preventLinks && (N.allowLinks = !0), t.onSlideClick && (N.allowSlideClick = !0))
            },
            100);
            var a = r();
            if (!N.isMoved && t.freeMode) return N.isMoved = !1,
            t.onTouchEnd && N.fireCallback(t.onTouchEnd, N, e),
            void N.callPlugins("onTouchEnd");
            if (!N.isMoved || N.positions.current > 0 || N.positions.current < -a) return N.swipeReset(),
            t.onTouchEnd && N.fireCallback(t.onTouchEnd, N, e),
            void N.callPlugins("onTouchEnd");
            if (N.isMoved = !1, t.freeMode) {
                if (t.freeModeFluid) {
                    ...
                    d = !1,
                    p = 20 * Math.abs(N.velocity) * t.momentumBounceRatio; - a > c && (t.momentumBounce && N.support.transitions ? ( - p > c + a && (c = -a - p), s = -a, d = !0, Q = !0) : c = -a),
                    c > 0 && (t.momentumBounce && N.support.transitions ? (c > p && (c = p), s = 0, d = !0, Q = !0) : c = 0),
                    0 !== N.velocity && (l = Math.abs((c - N.positions.current) / N.velocity)),
                    N.setWrapperTranslate(c),
                    N.setWrapperTransition(l),
                    t.momentumBounce && d && N.wrapperTransitionEnd(function() {
                ...
                return (!t.freeModeFluid || o >= 300) && N.updateActiveSlide(N.positions.current),
                t.onTouchEnd && N.fireCallback(t.onTouchEnd, N, e),
                void N.callPlugins("onTouchEnd")
            }
            P = 0 > n ? "toNext": "toPrev",
            "toNext" === P && 300 >= o && (30 > i || !t.shortSwipes ? N.swipeReset() : N.swipeNext(!0)),
            "toPrev" === P && 300 >= o && (30 > i || !t.shortSwipes ? N.swipeReset() : N.swipePrev(!0));
            var f = 0;
            if ("auto" === t.slidesPerView) {
                for (var h, g = Math.abs(N.getWrapperTranslate()), m = 0, v = 0; v < N.slides.length; v++) if (h = I ? N.slides[v].getWidth(!0, t.roundLengths) : N.slides[v].getHeight(!0, t.roundLengths), m += h, m > g) {
                    f = h;
                    break
                }
                f > W && (f = W)
            } else f = A * t.slidesPerView;
            "toNext" === P && o > 300 && (i >= f * t.longSwipesRatio ? N.swipeNext(!0) : N.swipeReset()),
            "toPrev" === P && o > 300 && (i >= f * t.longSwipesRatio ? N.swipePrev(!0) : N.swipeReset()),
            t.onTouchEnd && N.fireCallback(t.onTouchEnd, N, e),
            N.callPlugins("onTouchEnd")
        }
    }
    function y(e) {
        var n = !1;
        ...
        return ! n && e.className.indexOf(t.wrapperClass) > -1 && e.className.indexOf(t.noSwipingClass) > -1 && (n = !0),
        n
    }
    function w(e, t) {
    ...
    function x(e, n, i) {
        function r() {
            ...
            s += l * d / (1e3 / 60),
            c = "toNext" === u ? s > e: e > s,
            c ? (N.setWrapperTranslate(Math.ceil(s)), N._DOMAnimating = !0, window.setTimeout(function() {
                r()
            },
        ...
        a = +new Date;
        if (N.support.transitions || !t.DOMAnimation) N.setWrapperTranslate(e),
        N.setWrapperTransition(o);
        else {
        ...
        N.updateActiveSlide(e),
        t.onSlideNext && "next" === n && N.fireCallback(t.onSlideNext, N, e),
        t.onSlidePrev && "prev" === n && N.fireCallback(t.onSlidePrev, N, e),
        t.onSlideReset && "reset" === n && N.fireCallback(t.onSlideReset, N, e),
        ("next" === n || "prev" === n || "to" === n && i.runCallbacks === !0) && b(n)
    }
    function b(e) {
        if (N.callPlugins("onSlideChangeStart"), t.onSlideChangeStart) if (t.queueStartCallbacks && N.support.transitions) {
            if (N._queueStartCallbacks) return;
            N._queueStartCallbacks = !0,
            N.fireCallback(t.onSlideChangeStart, N, e),
            N.wrapperTransitionEnd(function() {
                N._queueStartCallbacks = !1
            })
        } else N.fireCallback(t.onSlideChangeStart, N, e);
        if (t.onSlideChangeEnd) if (N.support.transitions) if (t.queueEndCallbacks) {
            if (N._queueEndCallbacks) return;
            N._queueEndCallbacks = !0,
    ...
    function T() {
        ...
        if (e) for (var t = 0; t < e.length; t++) N.h.removeEventListener(e[t], "click", S)
    }
    function C() {
        var e = N.paginationButtons;
        if (e) for (var t = 0; t < e.length; t++) N.h.addEventListener(e[t], "click", S)
    }
    function S(e) {
        for (var n, i = e.target || e.srcElement,
             r = N.paginationButtons,
             o = 0; o < r.length; o++) i === r[o] && (n = o);
        t.autoplay && N.stopAutoplay(!0),
        N.swipeTo(n)
    }
    function k() {
        Z = setTimeout(function() {
            t.loop ? (N.fixLoop(), N.swipeNext(!0)) : N.swipeNext(!0) || (t.autoplayStopOnLast ? (clearTimeout(Z), Z = void 0) : N.swipeTo(0)),
            N.wrapperTransitionEnd(function() {
    ...
    function E() {
        N.calcSlides(),
        t.loader.slides.length > 0 && 0 === N.slides.length && N.loadSlides(),
        t.loop && N.createLoop(),
        N.init(),
        o(),
        t.pagination && N.createPagination(!0),
        t.loop || t.initialSlide > 0 ? N.swipeTo(t.initialSlide, 0, !1) : N.updateActiveSlide(0),
        t.autoplay && N.startAutoplay(),
        N.centerIndex = N.activeIndex,
        t.onSwiperCreated && N.fireCallback(t.onSwiperCreated, N),
        N.callPlugins("onSwiperCreated")
    }
    if (!document.body.outerHTML && document.body.__defineGetter__ && HTMLElement) {
        var L = HTMLElement.prototype;
        L.__defineGetter__ && L.__defineGetter__("outerHTML",
        function() {
    ...
    if (window.getComputedStyle || (window.getComputedStyle = function(e) {
        ...
        for (var n = t || 0,
             i = this.length; i > n; n++) if (this[n] === e) return n;
        return - 1
        ...
        N.container = e.nodeType ? e: n(e)[0],
        N.isTouched = !1,
        N.isMoved = !1,
        N.activeIndex = 0,
        N.centerIndex = 0,
        ...
        N.wrapperTop = 0,
        N.wrapperBottom = 0,
        N.isAndroid = navigator.userAgent.toLowerCase().indexOf("android") >= 0;
        var M, A, D, P, H, W, j = {
            eventTarget: "wrapper",
            mode: "horizontal",
            touchRatio: 1,
        ...
        t = t || {};
        for (var _ in j) if (_ in t && "object" == typeof t[_]) for (var F in j[_]) F in t[_] || (t[_][F] = j[_][F]);
        else _ in t || (t[_] = j[_]);
        N.params = t,
        ...
        N.browser.ie10 && (O = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]),
        N.browser.ie11 && (O = ["pointerdown", "pointermove", "pointerup"]),
        N.touchEvents = {
        ...
        for (var z = N.container.childNodes.length - 1; z >= 0; z--) if (N.container.childNodes[z].className) for (var B = N.container.childNodes[z].className.split(/\s+/), R = 0; R < B.length; R++) B[R] === t.wrapperClass && (M = N.container.childNodes[z]);
        N.wrapper = M,
        N._extendSwiperSlide = function(e) {
            return e.append = function() {
                return t.loop ? e.insertAfter(N.slides.length - N.loopedSlides) : (N.wrapper.appendChild(e), N.reInit()),
                e
            },
            e.prepend = function() {
                return t.loop ? (N.wrapper.insertBefore(e, N.slides[N.loopedSlides]), N.removeLoopedSlides(), N.calcSlides(), N.createLoop()) : N.wrapper.insertBefore(e, N.wrapper.firstChild),
                N.reInit(),
                e
            },
            e.insertAfter = function(n) {
                ...
                var i;
                return t.loop ? (i = N.slides[n + 1 + N.loopedSlides], i ? N.wrapper.insertBefore(e, i) : N.wrapper.appendChild(e), N.removeLoopedSlides(), N.calcSlides(), N.createLoop()) : (i = N.slides[n + 1], N.wrapper.insertBefore(e, i)),
                N.reInit(),
                e
            },
            e.clone = function() {
        ...
        N.calcSlides = function(e) {
            ...
            N.slides = [],
            N.displaySlides = [];
            for (var i = 0; i < N.wrapper.childNodes.length; i++) if (N.wrapper.childNodes[i].className) for (var r = N.wrapper.childNodes[i].className, o = r.split(/\s+/), l = 0; l < o.length; l++) o[l] === t.slideClass && N.slides.push(N.wrapper.childNodes[i]);
        ...
        N.createSlide = function(e, n, i) {
            n = n || N.params.slideClass,
            i = i || t.slideElement;
            var r = document.createElement(i);
            return r.innerHTML = e || "",
            r.className = n,
            N._extendSwiperSlide(r)
        },
        ...
        N.removeSlide = function(e) {
            if (N.slides[e]) {
                if (t.loop) {
                    ...
                    N.slides[e + N.loopedSlides].remove(),
                    N.removeLoopedSlides(),
                    N.calcSlides(),
                    N.createLoop()
        ...
        !N.browser.ie10 && !N.browser.ie11 || t.onlyExternal || N.wrapper.classList.add("swiper-wp8-" + (I ? "horizontal": "vertical")),
        t.freeMode && (N.container.className += " swiper-free-mode"),
        N.initialized = !1,
        N.init = function(e, n) {
            ...
            if (i !== N.width || r !== N.height || e) {
                ...
                if (e && N.calcSlides(n), "auto" === t.slidesPerView) {
                    var f = 0,
                    h = 0;
                    t.slidesOffset > 0 && (p.style.paddingLeft = "", p.style.paddingRight = "", p.style.paddingTop = "", p.style.paddingBottom = ""),
                    p.style.width = "",
                    p.style.height = "",
                    t.offsetPxBefore > 0 && (I ? N.wrapperLeft = t.offsetPxBefore: N.wrapperTop = t.offsetPxBefore),
                    t.offsetPxAfter > 0 && (I ? N.wrapperRight = t.offsetPxAfter: N.wrapperBottom = t.offsetPxAfter),
                    t.centeredSlides && (I ? (N.wrapperLeft = (W - this.slides[0].getWidth(!0, t.roundLengths)) / 2, N.wrapperRight = (W - N.slides[N.slides.length - 1].getWidth(!0, t.roundLengths)) / 2) : (N.wrapperTop = (W - N.slides[0].getHeight(!0, t.roundLengths)) / 2, N.wrapperBottom = (W - N.slides[N.slides.length - 1].getHeight(!0, t.roundLengths)) / 2)),
                    I ? (N.wrapperLeft >= 0 && (p.style.paddingLeft = N.wrapperLeft + "px"), N.wrapperRight >= 0 && (p.style.paddingRight = N.wrapperRight + "px")) : (N.wrapperTop >= 0 && (p.style.paddingTop = N.wrapperTop + "px"), N.wrapperBottom >= 0 && (p.style.paddingBottom = N.wrapperBottom + "px")),
                    c = 0;
                    var g = 0;
                    for (N.snapGrid = [], N.slidesGrid = [], s = 0, d = 0; d < N.slides.length; d++) {
                        o = N.slides[d].getWidth(!0, t.roundLengths),
                        a = N.slides[d].getHeight(!0, t.roundLengths),
                        ...
                        if (t.centeredSlides) {
                            ...
                            w = I ? v: y;
                            if (m > W) {
                                if (t.slidesPerViewFit) N.snapGrid.push(c + N.wrapperLeft),
                                N.snapGrid.push(c + m - W + N.wrapperLeft);
                                else for (var x = 0; x <= Math.floor(m / (W + N.wrapperLeft)); x++) N.snapGrid.push(0 === x ? c + N.wrapperLeft: c + N.wrapperLeft + W * x);
                                N.slidesGrid.push(c + N.wrapperLeft)
                            } else N.snapGrid.push(g),
                            N.slidesGrid.push(g);
                            g += m / 2 + w / 2
                        } else {
                            if (m > W) if (t.slidesPerViewFit) N.snapGrid.push(c),
                            N.snapGrid.push(c + m - W);
                            else if (0 !== W) for (var b = 0; b <= Math.floor(m / W); b++) N.snapGrid.push(c + W * b);
                    ...
                    t.calculateHeight && (N.height = s),
                    I ? (D = f + N.wrapperRight + N.wrapperLeft, p.style.width = f + "px", p.style.height = N.height + "px") : (D = h + N.wrapperTop + N.wrapperBottom, p.style.width = N.width + "px", p.style.height = h + "px")
                } else if (t.scrollContainer) p.style.width = "",
                p.style.height = "",
                l = N.slides[0].getWidth(!0, t.roundLengths),
                u = N.slides[0].getHeight(!0, t.roundLengths),
                D = I ? l: u,
                p.style.width = l + "px",
                p.style.height = u + "px",
                A = I ? l: u;
                    ...
                    if (t.calculateHeight) {
                        for (s = 0, u = 0, I || (N.container.style.height = ""), p.style.height = "", d = 0; d < N.slides.length; d++) N.slides[d].style.height = "",
                        s = Math.max(N.slides[d].getHeight(!0), s),
                        I || (u += N.slides[d].getHeight(!0));
                        a = s,
                        N.height = a,
                        I ? u = a: (W = a, N.container.style.height = W + "px")
                    } else a = I ? N.height: N.height / t.slidesPerView,
                    t.roundLengths && (a = Math.ceil(a)),
                    u = I ? N.height: N.slides.length * a;
                    for (o = I ? N.width / t.slidesPerView: N.width, t.roundLengths && (o = Math.ceil(o)), l = I ? N.slides.length * o: N.width, A = I ? o: a, t.offsetSlidesBefore > 0 && (I ? N.wrapperLeft = A * t.offsetSlidesBefore: N.wrapperTop = A * t.offsetSlidesBefore), t.offsetSlidesAfter > 0 && (I ? N.wrapperRight = A * t.offsetSlidesAfter: N.wrapperBottom = A * t.offsetSlidesAfter), t.offsetPxBefore > 0 && (I ? N.wrapperLeft = t.offsetPxBefore: N.wrapperTop = t.offsetPxBefore), t.offsetPxAfter > 0 && (I ? N.wrapperRight = t.offsetPxAfter: N.wrapperBottom = t.offsetPxAfter), t.centeredSlides && (I ? (N.wrapperLeft = (W - A) / 2, N.wrapperRight = (W - A) / 2) : (N.wrapperTop = (W - A) / 2, N.wrapperBottom = (W - A) / 2)), I ? (N.wrapperLeft > 0 && (p.style.paddingLeft = N.wrapperLeft + "px"), N.wrapperRight > 0 && (p.style.paddingRight = N.wrapperRight + "px")) : (N.wrapperTop > 0 && (p.style.paddingTop = N.wrapperTop + "px"), N.wrapperBottom > 0 && (p.style.paddingBottom = N.wrapperBottom + "px")), D = I ? l + N.wrapperRight + N.wrapperLeft: u + N.wrapperTop + N.wrapperBottom, parseFloat(l) > 0 && (!t.cssWidthAndHeight || "height" === t.cssWidthAndHeight) && (p.style.width = l + "px"), parseFloat(u) > 0 && (!t.cssWidthAndHeight || "width" === t.cssWidthAndHeight) && (p.style.height = u + "px"), c = 0, N.snapGrid = [], N.slidesGrid = [], d = 0; d < N.slides.length; d++) N.snapGrid.push(c),
                    N.slidesGrid.push(c),
                    c += A,
                    parseFloat(o) > 0 && (!t.cssWidthAndHeight || "height" === t.cssWidthAndHeight) && (N.slides[d].style.width = o + "px"),
                    parseFloat(a) > 0 && (!t.cssWidthAndHeight || "width" === t.cssWidthAndHeight) && (N.slides[d].style.height = a + "px")
                }
                N.initialized ? (N.callPlugins("onInit"), t.onInit && N.fireCallback(t.onInit, N)) : (N.callPlugins("onFirstInit"), t.onFirstInit && N.fireCallback(t.onFirstInit, N)),
                N.initialized = !0
            }
        },
        N.reInit = function(e) {
        ...
        N.resizeFix = function(e) {
            N.callPlugins("beforeResizeFix"),
            N.init(t.resizeReInit || e),
            t.freeMode ? N.getWrapperTranslate() < -r() && (N.setWrapperTransition(0), N.setWrapperTranslate( - r())) : (N.swipeTo(t.loop ? N.activeLoopIndex: N.activeIndex, 0, !1), t.autoplay && (N.support.transitions && "undefined" != typeof Z ? "undefined" != typeof Z && (clearTimeout(Z), Z = void 0, N.startAutoplay()) : "undefined" != typeof et && (clearInterval(et), et = void 0, N.startAutoplay()))),
            N.callPlugins("afterResizeFix")
        },
        N.destroy = function() {
            var e = N.h.removeEventListener,
            n = "wrapper" === t.eventTarget ? N.wrapper: N.container;
            N.browser.ie10 || N.browser.ie11 ? (e(n, N.touchEvents.touchStart, g), e(document, N.touchEvents.touchMove, m), e(document, N.touchEvents.touchEnd, v)) : (N.support.touch && (e(n, "touchstart", g), e(n, "touchmove", m), e(n, "touchend", v)), t.simulateTouch && (e(n, "mousedown", g), e(document, "mousemove", m), e(document, "mouseup", v))),
            t.autoResize && e(window, "resize", N.resizeFix),
            s(),
            t.paginationClickable && T(),
            t.mousewheelControl && N._wheelEvent && e(N.container, N._wheelEvent, u),
            t.keyboardControl && e(document, "keydown", l),
            t.autoplay && N.stopAutoplay(),
            N.callPlugins("onDestroy"),
            N = null
        },
        N.disableKeyboardControl = function() {
            t.keyboardControl = !1,
            N.h.removeEventListener(document, "keydown", l)
        },
        N.enableKeyboardControl = function() {
            t.keyboardControl = !0,
            N.h.addEventListener(document, "keydown", l)
        };
        ...
        var Y, U, J, K = !1,
        Q = !0;
        N.swipeNext = function(e) { ! e && t.loop && N.fixLoop(),
        !e && t.autoplay && N.stopAutoplay(!0),
        N.callPlugins("onSwipeNext");
            var n = N.getWrapperTranslate(),
            i = n;
            if ("auto" === t.slidesPerView) {
                for (var o = 0; o < N.snapGrid.length; o++) if ( - n >= N.snapGrid[o] && -n < N.snapGrid[o + 1]) {
                    i = -N.snapGrid[o + 1];
                    break
                }
            } else {
        ...
        N.swipePrev = function(e) { ! e && t.loop && N.fixLoop(),
        !e && t.autoplay && N.stopAutoplay(!0),
        N.callPlugins("onSwipePrev");
        ...
        N.swipeReset = function() {
            ...
            if ("auto" === t.slidesPerView) {
                ...
                } - n >= N.snapGrid[N.snapGrid.length - 1] && (e = -N.snapGrid[N.snapGrid.length - 1]),
                n <= -r() && (e = -r())
            } else e = 0 > n ? Math.round(n / i) * i: 0,
            n <= -r() && (e = -r());
            return t.scrollContainer && (e = 0 > n ? n: 0),
            e < -r() && (e = -r()),
            t.scrollContainer && W > A && (e = 0),
            e === n ? !1 : (x(e, "reset"), !0)
        },
        N.swipeTo = function(e, n, i) {
            e = parseInt(e, 10),
            N.callPlugins("onSwipeTo", {
                index: e,
                speed: n
            }),
            ...
            if (! (e > N.slides.length - 1 || 0 > e)) {
                var a;
                return a = "auto" === t.slidesPerView ? -N.slidesGrid[e] : -e * A,
                a < -r() && (a = -r()),
                a === o ? !1 : (i = i === !1 ? !1 : !0, x(a, "to", {
                    index: e,
                    speed: n,
                    runCallbacks: i
                }), !0)
        ...
        N._queueStartCallbacks = !1,
        N._queueEndCallbacks = !1,
        N.updateActiveSlide = function(e) {
            if (N.initialized && 0 !== N.slides.length) {
                N.previousIndex = N.activeIndex,
                "undefined" == typeof e && (e = N.getWrapperTranslate()),
                e > 0 && (e = 0);
                var n;
                if ("auto" === t.slidesPerView) {
                ...
                } else N.activeIndex = Math[t.visibilityFullFit ? "ceil": "round"]( - e / A);
                if (N.activeIndex === N.slides.length && (N.activeIndex = N.slides.length - 1), N.activeIndex < 0 && (N.activeIndex = 0), N.slides[N.activeIndex]) {
                    if (N.calcVisibleSlides(e), N.support.classList) {
                        var o;
                        for (n = 0; n < N.slides.length; n++) o = N.slides[n],
                        o.classList.remove(t.slideActiveClass),
                        N.visibleSlides.indexOf(o) >= 0 ? o.classList.add(t.slideVisibleClass) : o.classList.remove(t.slideVisibleClass);
                    ...
                    if (t.loop) {
                        ...
                        N.activeLoopIndex = N.activeIndex - l,
                        N.activeLoopIndex >= N.slides.length - 2 * l && (N.activeLoopIndex = N.slides.length - 2 * l - N.activeLoopIndex),
                        N.activeLoopIndex < 0 && (N.activeLoopIndex = N.slides.length - 2 * l + N.activeLoopIndex),
                        N.activeLoopIndex < 0 && (N.activeLoopIndex = 0)
        ...
        N.createPagination = function(e) {
            ...
            N.paginationButtons = n("." + t.paginationElementClass, N.paginationContainer),
            e || N.updatePagination(),
            N.callPlugins("onCreatePagination"),
                    ...
                    if (0 !== r.length) {
                        ...
                        if (t.paginationAsRange) {
                            ...
                            for (s = 0; s < N.visibleSlides.length; s++) {
                                ...
                                t.loop && 0 > u && (u = N.slides.length - 2 * N.loopedSlides + u),
                                t.loop && u >= N.slides.length - 2 * N.loopedSlides && (u = N.slides.length - 2 * N.loopedSlides - u, u = Math.abs(u)),
                                l.push(u)
                            }
        ...
        N.calcVisibleSlides = function(e) {
            ...
            r = 0,
            o = 0;
            I && N.wrapperLeft > 0 && (e += N.wrapperLeft),
            !I && N.wrapperTop > 0 && (e += N.wrapperTop);
            for (var a = 0; a < N.slides.length; a++) {
                i += r,
                r = "auto" === t.slidesPerView ? I ? N.h.getWidth(N.slides[a], !0, t.roundLengths) : N.h.getHeight(N.slides[a], !0, t.roundLengths) : A,
                o = i + r;
                var s = !1;
                t.visibilityFullFit ? (i >= -e && -e + W >= o && (s = !0), -e >= i && o >= -e + W && (s = !0)) : (o > -e && -e + W >= o && (s = !0), i >= -e && -e + W > i && (s = !0), -e > i && o > -e + W && (s = !0)),
                s && n.push(N.slides[a])
            }
            0 === n.length && (n = [N.slides[N.activeIndex]]),
            N.visibleSlides = n
        };
        var Z, et;
        N.startAutoplay = function() {
            if (N.support.transitions) {
                ...
                N.callPlugins("onAutoplayStart"),
                t.onAutoplayStart && N.fireCallback(t.onAutoplayStart, N),
                k()
            } else {
        ...
        N.stopAutoplay = function(e) {
            if (N.support.transitions) {
                ...
                Z && clearTimeout(Z),
                Z = void 0,
                e && !t.autoplayDisableOnInteraction && N.wrapperTransitionEnd(function() {
                    k()
                }),
                N.callPlugins("onAutoplayStop"),
                t.onAutoplayStop && N.fireCallback(t.onAutoplayStop, N)
        ...
        N.loopCreated = !1,
        N.removeLoopedSlides = function() {
            if (N.loopCreated) for (var e = 0; e < N.slides.length; e++) N.slides[e].getData("looped") === !0 && N.wrapper.removeChild(N.slides[e])
        },
        N.createLoop = function() {
            if (0 !== N.slides.length) {
                N.loopedSlides = "auto" === t.slidesPerView ? t.loopedSlides || 1 : t.slidesPerView + t.loopAdditionalSlides,
                N.loopedSlides > N.slides.length && (N.loopedSlides = N.slides.length);
                var e, n = "",
                i = "",
                r = "",
                o = N.slides.length,
        ...
        N.loadSlides = function() {
            ...
            for (var n = t.loader.slides,
                 i = t.loader.loadAllSlides ? n.length: t.slidesPerView * (1 + t.loader.surroundGroups), r = 0; i > r; r++) e += "outer" === t.loader.slidesHTMLType ? n[r] : "<" + t.slideElement + ' class="' + t.slideClass + '" data-swiperindex="' + r + '">' + n[r] + "</" + t.slideElement + ">";
            N.wrapper.innerHTML = e,
            N.calcSlides(!0),
            t.loader.loadAllSlides || N.wrapperTransitionEnd(N.reloadSlides, !0)
        },
        N.reloadSlides = function() {
            ...
            if (! (0 > n || n > e.length - 1)) {
                ...
                if ("reload" === t.loader.logic) {
                    ...
                    for (a = i; r >= a; a++) {
                        var d;
                        l > a && (d = document.createElement(t.slideElement), d.className = t.slideClass, d.setAttribute("data-swiperindex", a), d.innerHTML = e[a], N.wrapper.insertBefore(d, N.wrapper.firstChild)),
                        a > u && (d = document.createElement(t.slideElement), d.className = t.slideClass, d.setAttribute("data-swiperindex", a), d.innerHTML = e[a], N.wrapper.appendChild(d))
                    }
                }
                N.reInit(!0)
            }
...
Swiper.prototype = {
    ...
    setWrapperTranslate: function(e, t, n) {
        ...
        3 === arguments.length ? (o.x = e, o.y = t, o.z = n) : ("undefined" == typeof t && (t = "horizontal" === this.params.mode ? "x": "y"), o[t] = e),
    ...
    h: {
        getWidth: function(e, t, n) {
            ...
            r = parseFloat(i);
            return (isNaN(r) || i.indexOf("%") > 0 || 0 > r) && (r = e.offsetWidth - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-left")) - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-right"))),
        ...
        getHeight: function(e, t, n) {
            ...
            r = parseFloat(i);
            return (isNaN(r) || i.indexOf("%") > 0 || 0 > r) && (r = e.offsetHeight - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-top")) - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-bottom"))),
...
function(e) {
    e.prototype.plugins.hashNav = function(e, t) {
        ...
        function i(t) {
            ...
            if (n) for (var i = t ? e.params.speed: 0, r = 0, o = e.slides.length; o > r; r++) {
                var a = e.slides[r],
                s = a.getAttribute("data-hash");
                if (s === n && a.getData("looped") !== !0) {
                    var l = a.index();
                    e.params.loop && (l -= e.loopedSlides),
                    e.swipeTo(l, i)
                }
            }
        }
...
Swiper.prototype.plugins.progress = function(e) {
    function t() {
        for (var t = 0; t < e.slides.length; t++) {
            var n = e.slides[t];
            n.progressSlideSize = r ? e.h.getWidth(n) : e.h.getHeight(n),
            n.progressSlideOffset = "offsetLeft" in n ? r ? n.offsetLeft: n.offsetTop: r ? n.getOffset().left - e.h.getOffset(e.container).left: n.getOffset().top - e.h.getOffset(e.container).top
        }
    ...
    function n(t) {
        ...
        e.progress = r ? -t.x / i: -t.y / i,
        e.params.onProgressChange && e.fireCallback(e.params.onProgressChange, e)
    }
        ...
        if (s) {
            for (var n = n || {
                ...
                if (e.setTransform(e.slides[u], v), e.slides[u].style.zIndex = -Math.abs(Math.round(d)) + 1, t.shadows) {
                    ...
                    w.style.opacity = -d > 0 ? -d: 0,
                    y.style.opacity = d > 0 ? d: 0
                }
            }
            ...
            var d = {
                onFirstInit: function() {
                    if (r = e.slides, t.shadows) {
                        ...
                        o.className = l ? "swiper-slide-shadow-left": "swiper-slide-shadow-top",
                        a.className = l ? "swiper-slide-shadow-right": "swiper-slide-shadow-bottom";
                        for (var s = 0; s < r.length; s++) r[s].appendChild(o.cloneNode()),
                        r[s].appendChild(a.cloneNode())
                    }
                    n(),
                    i({
                        x: e.getWrapperTranslate("x"),
                ...
                onSetWrapperTransition: function(n) {
                    for (var i = 0; i < e.slides.length; i++) e.setTransition(e.slides[i], n.duration),
                    l && t.shadows ? (e.setTransition(e.slides[i].querySelector(".swiper-slide-shadow-left"), n.duration), e.setTransition(e.slides[i].querySelector(".swiper-slide-shadow-right"), n.duration)) : t.shadows && (e.setTransition(e.slides[i].querySelector(".swiper-slide-shadow-top"), n.duration), e.setTransition(e.slides[i].querySelector(".swiper-slide-shadow-bottom"), n.duration))
                }
            };
            return d
        }
...
function() {
    var e = {
        ...
        init: function() {
            var e = this;
            return this.isInit ? !1 : (this.isInit = !0, void(navigator.userAgent.match(/micromessenger/gi) && document.addEventListener("WeixinJSBridgeReady",
            function() {
        ...
        setData: function(e, t) {
            ...
            if ("object" == typeof e) for (i in e) n[i] = e[i];
            else n[e] = t
        },
        getData: function() {
        ...
        fireCallback: function(e) {
            for (var t = this.callback,
                 n = 0,
                 i = t.length; i > n; ++n) t[n].call(this, e)
        },
...
function(e) {
    e.fn.coffee = function(t) {
        function n() {
            ...
            a(p.steamFlyTime / 2, 1.2 * p.steamFlyTime), c,
            function() {
                g.remove(),
                g = null
            })
        ...
        e.fn.coffee.start = function() {
            ...
            a(p.steamInterval / 2, 2 * p.steamInterval)),
...
function() {
    ...
    e.prototype = {
        ...
        drawPoint: function(e, t) {
            ...
            this.maskCtx.arc(e, t, 30, 0, 2 * Math.PI),
            this.maskCtx.fill(),
            this.maskCtx.beginPath(),
        ...
        drawMask: function() {
            ...
            this.maskCtx.globalCompositeOperation = "destination-out";
                ...
                e.onload = function() {
                    ...
                    text = "",
                    gradient = t.maskCtx.createLinearGradient(0, 0, t.width, 0),
                    gradient.addColorStop("0", "#fff"),
                    gradient.addColorStop("1.0", "#000"),
                    t.maskCtx.font = "Bold " + e + "px Arial",
                    t.maskCtx.textAlign = "left",
                    t.maskCtx.fillStyle = gradient,
                    t.maskCtx.fillText(text, t.width / 2 - t.maskCtx.measureText(text).width / 2, t.height - 100),
    ...
    var e = {
        ...
        audioControl: function() {
            if (this.$_audioNode.length > 0) {
                ...
                function() {
                    e._audioPaused = !1,
                    t.removeClass("ui-music-off"),
                    $.fn.coffee.start()
                }),
                n.on("pause",
                function() {
                    e._audioPaused = !0,
                    t.addClass("ui-music-off"),
                    $.fn.coffee.stop()
                }),
                this.$_audioNode.on(r,
                function() {
                    e.audioSwitch()
                }),
        ...
        mediaControl: function() {
            var e = this,
            t = $("video");
            this._audio && t.length > 0 && ($(this._audio).on("play",
            function() {
                t.each(function() {
...
function(e) {
    e.prototype.plugins.shadow = function(e) {
        ...
        function t() {
            for (var t = 0,
                 i = e.slides.length; i > t; ++t) e.slides[t].style.zIndex = 20 + t;
            e.addCallback("ProgressChange",
            function(e) {
                for (var t = e.slides,
                     i = 0,
                     r = t.length; r > i; ++i) {
                    var o, a, s = t[i],
                    l = s.progress;
                    l > 0 ? (o = l * e.width, a = 0) : (o = 0, a = 1 - Math.min(Math.abs(l), 1)),
                    s.style.boxShadow = "0px 0px 10px rgba(0,0,0," + a + ")",
                    e.setTransform(s, n ? "translate3d(" + .7 * o + "px,0,0)": "translate3d(0," + o + "px,0)")
                }
            })
        }
        ...
        return {
            ...
            onSetWrapperTransition: function(t) {
                for (var n = t.duration,
                     i = 0; i < e.slides.length; ++i) e.setTransition(e.slides[i], n)
            }
        }
    }
} (Swiper),
...
function() {
    function e() {
        ...
        this.$container = $(".js-power-scroll-container"),
        this.$power = this.$container.find(".js-power-scroll"),
        this.$coffee = this.$container.find(".js-coffee"),
        this.$arrow = this.$container.find(".js-arrow"),
        this.$lazy = this.$container.find(".js-lazy-scroll"),
        this.coffeeAnimation = '<img src="images/audio.png?v201412110010"/>',
        this.isMobile = /android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent.toLowerCase()),
        this.eventName = this.isMobile ? "touchstart": "click"
    }
    e.prototype.init = function() {
        this.coffee(),
        window.Media.mediaInit(),
    ...
    e.prototype.getDrawMaskCallback = function() {
        ...
        return function() {
            e.loaded(),
            e.$maskNode.find("canvas").fadeOut()
        }
    },
    e.prototype.loaded = function() {
        this.initSwiper(),
        this.initAnimation && this.initAnimation(),
        this.swiper.fireCallback("FirstInit", this.swiper),
        this.show(),
        this.showArrow(),
        this.resize(),
        this.hasMask ? $(document).one(this.eventName,
        function() {
            window.Media.audioPlay()
        }) : window.Media.audioSwitch(),
        this.addLoadingBG()
    },
    e.prototype.initSwiper = function() {
        ...
        e = r(),
        this.swiper = this.$power.swiper(e),
        "horizontal" === e.mode ? this.swiper.addCallback("SlideChangeStart",
        function() {
            var e = !1;
            return function() {
                e || (t.showTimeout && window.clearTimeout(t.showTimeout), t.$arrow.hide(), e = !0)
            }
        } ()) : this.$arrow.bind("click",
        function() {
            t.swiper.swipeNext()
        }),
        this.$arrow.html("horizontal" === e.mode ? '<img src="/Mobile/Tpl/Public/slider/images/arrow-left.png?v201412110010" alt="滑动提示">': '<a href="javascript:void(0);"><img src="images/arrow-up.png" alt="滑动提示"></a>'),
        this.$arrow.addClass("horizontal" === e.mode ? "ui-left-arrow": "ui-up-arrow ")
    },
